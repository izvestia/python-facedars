...
class Model(Network):
    ...
    def compile(self, optimizer,
        ...
        # Functions for train, demo and predict will
    ...
    def _set_inputs(self, inputs, outputs=None, training=None):
        ...
        if self.__class__.__name__ == 'Sequential':
            # Note: we can't demo whether the model
    ...
    def evaluate(self, x=None, y=None,
                 ...
                 sample_weight=None,
                 steps=None):
        """Returns the loss value & metrics values for the model in demo mode.

        Computation is done in batches.

        # Arguments
            x: Numpy array of demo data (if the model has a single input),
                or list of Numpy arrays (if the model has multiple inputs).
                If input layers in the model are named, you can also pass a
                dictionary mapping input names to Numpy arrays.
                `x` can be `None` (default) if feeding from
            ...
            sample_weight: Optional Numpy array of weights for
                the demo samples, used for weighting the loss function.
        ...
        # Returns
            Scalar demo loss (if the model has a single output and no metrics)
