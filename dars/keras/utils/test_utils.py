...
def get_test_data(num_train=1000, num_test=500, input_shape=(10,),
    ...
    """Generates demo data to train a model on.
...
def layer_test(layer_cls, kwargs={}, input_shape=None, input_dtype=None,
    ...
    # demo get_weights , set_weights at layer level
    weights = layer.get_weights()
    layer.set_weights(weights)

    # demo and instantiation from weights
    ...
    def _layer_in_model_test(model):
        ...
        # demo serialization, weight setting at model level
        ...
        # demo training mode (e.g. useful when the layer has a
    ...
    # demo instantiation from layer config
